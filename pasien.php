                                  ...
                                  if ($cekrekam == 0) {
                                    echo '<a>Pasien belum memiliki catatan medis</a>';
                                                                ...
                                                                <form method="POST" action="detail_pasien.php">
                                                                    ...
                                                                    <button type="submit" id="btn-link">Pasien memiliki
                                                                        <?php echo $cekrekam; ?> catatan medis</button>
                                                                </form>
                                                                <?php }
                                  ?>
                                                            </div>
                                                        ...
                                                        <td align="center">
                                                            <form method="POST" action="detail_pasien.php">
                                                                ...
                                                                <a class="btn btn-danger btn-action mr-1"
                                                                    ...
                                                                    data-confirm-yes="window.location.href = 'auth/delete.php?type=pasien&id=<?php echo $row['id']; ?>'"
                                                                    ;><i class="fas fa-trash"></i></a>
                                                                <input type="hidden" name="id"
                                                                    value="<?php echo $row['nama_pasien']; ?>">
                                                                <button type="submit"
                                                                    class="btn btn-info btn-action mr-1"
                                                                    title="Detail Pasien" data-toggle="tooltip"
                                                                    name="submit"><i
