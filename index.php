                  ...
                  ?>
                          ...
                          if ($showruangan["status"] == "0") {
                            ...
                            echo '<i class="ion-gear-b"></i>  Dalam Perbaikan';
                                            ...
                                            <h6 class="media-title"><a href="#">Ruang
                                                    <?php echo $showruangan["nama_ruang"]; ?></a></h6>
                                ...
                                <div class="card-body">
                                    <div class="col-lg-12">
                                        <div class="card card-large-icons">
                                            ...
                                            <div class="card-body">
                                                <h4>Rawat Inap</h4>
                                                <a href="ruangan.php" class="card-cta">Detail <i
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card card-large-icons">
                                            ...
                                            <div class="card-body">
                                                <h4>Data Obat</h4>
                                                <a href="obat.php" class="card-cta">Detail <i
                                                        class="fas fa-chevron-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
